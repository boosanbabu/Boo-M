...
<h2>Sliding Window Template</h2>

Among all leetcode questions, I find that there are at least 5 substring search problem which could be solved by the sliding window algorithm. Courtesy : HarryChaoyangHe
...
Solution for these questions use the above template one by one
